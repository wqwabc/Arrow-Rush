...
# ------------------------------------------------------------------ 音效
SFX_VOLUME = 0.55                # 0~1，改这里就能整体调音量

# ------------------------------------------------------------------ 动画
SCENE_FADE_SECONDS = 0.30        # 切界面时从黑场淡入的时长
HOVER_LERP = 14.0                # 悬停动画的收敛速度（越大越快）
BUTTON_LERP = 16.0
ARROW_ENTER_SECONDS = 0.30       # 单个箭头入场动画时长
ARROW_ENTER_STAGGER = 0.035      # 相邻箭头之间的入场延迟
